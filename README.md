...
Welcome to **VoX - Overlay Pro v5.0.1 (English Version)**!  
...
2. **Install the Script:**  
   ...
   [**⬇️ Click here to install the English version (v5.0.1)**](https://github.com/Jay-pn34/Wplace_VoX-Overlay-Pro-ENG/raw/refs/heads/main/WplacePro-VoX.user.js)  
...
- **Settings (⚙️):** Switch theme (Light/Dark) and adjust panel transparency.  
